...
public class DevDBSetup
{
    ...
    private readonly YCodeLabDummyDataSeed<YCodeLabDbContextFactory> _dataSeed;
    ...
    public DevDBSetup(AppSettings settings, Microsoft.Extensions.Logging.ILogger logger)
    {
        ...
        _dataSeed = new YCodeLabDummyDataSeed<YCodeLabDbContextFactory>(dbContextFactory, LoggerFactory.CreateLogger<YCodeLabDummyDataSeed<YCodeLabDbContextFactory>>());
    }
