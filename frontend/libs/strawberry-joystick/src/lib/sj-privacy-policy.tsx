...
export function _SJPrivacyPolicy(props: Props) {
  return (
    <div className={styles['sj-privacy-policy']}>

      <h1>Privacy Policy</h1>

      <ul className="h2">
        <li>
          <img src="/assets/icon-power-maniac.png" alt="Power Maniac Icon" style={{ margin: 10, height: 18 }}/>
      ...
      <div className={styles['sj-privacy-policy-section']}>
        <Container>

          <h2>
            <img src="/assets/icon-power-maniac.png" alt="Power Maniac Icon" style={{ margin: 12, height: 24 }}/>
