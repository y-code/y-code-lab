  ...
  return (
    <Container>
      <Row>
        ...
        <Col sm={12} md={12} lg={12} xl={12} className='profile-content-col text-light px-3'>
          <Row className="py-3 align-items-center">
            <Col sm={12} md={6} lg={6} xl={6} className="p-2 text-center">
              <div className="LI-profile-badge d-flex justify-content-center"  data-version="v1" data-size="large" data-locale="en_US" data-type="horizontal" data-theme="light" data-vanity="yasuikeda">
                <a className="LI-simple-link" href='https://nz.linkedin.com/in/yasuikeda?trk=profile-badge'></a>
              </div>
            </Col>
            <Col sm={12} md={6} lg={6} xl={6} className="p-2">
